...
import { ChevronDown, FileText, Image, Layers, Crop, QrCode } from 'lucide-react';
import { useState } from 'react';

const TOOLS = [
  { to: '/', label: 'PDF Compressor', icon: FileText },
  { to: '/image-compressor', label: 'Image Compressor', icon: Image },
  { to: '/pdf-merger', label: 'PDF Merger', icon: Layers },
  { to: '/image-resizer', label: 'Image Resizer', icon: Crop },
