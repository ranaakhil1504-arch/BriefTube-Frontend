...
export default function SummaryCard({
  ...
  return (
    <div className="animate-summary mx-auto mt-10 w-full max-w-6xl overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-xl transition-shadow duration-300 md:hover:shadow-2xl dark:border-gray-700 dark:bg-gray-900">
      {/* Thumbnail */}
      <div className="relative">
        ...
        {/* Video Badge */}
        <div className="absolute left-6 top-6 flex items-center gap-2 rounded-full bg-white/90 px-4 py-2 shadow-lg dark:bg-gray-900/80">
      ...
      <div className="p-8 dark:bg-gray-900">
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              onClick={handleCopy}
              className={`flex items-center gap-2 rounded-xl px-5 py-3 font-semibold transition-colors duration-300 ${
                copied
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-gray-700 px-5 py-3 font-semibold text-white transition-colors duration-300 md:hover:bg-gray-800"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 font-semibold text-white transition-colors duration-300 md:hover:bg-indigo-700"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-red-600 px-5 py-3 font-semibold text-white transition-colors duration-300 md:hover:bg-red-700"
            >
            ...
            <button
              onClick={handleShare}
              className="rounded-lg bg-emerald-600 px-4 py-2 font-medium text-white transition-colors md:hover:bg-emerald-700"
            >
              🔗 Share
            </button>
            <button
              onClick={onClear}
              className="rounded-lg bg-gray-600 px-4 py-2 font-medium text-white transition-colors md:hover:bg-gray-700"
            >
              🗑 Clear
            </button>
          </div>
        ...
        <div className="rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 to-slate-50 p-8 shadow-inner dark:border-gray-700 dark:from-gray-900 dark:to-gray-800">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                {parsed.keyPoints.map((point, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-4 rounded-2xl border border-blue-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900"
                  >
            ...
            <div className="mb-8">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {parsed.keyTakeaways.map((item, index) => (
                  <div
                    key={index}
                    className="rounded-2xl border border-amber-200 bg-gradient-to-br from-yellow-50 to-white p-5 shadow-sm dark:border-yellow-800 dark:from-gray-900 dark:to-gray-800"
                  >
          ...
          {parsed.quickSummary && (
            <div className="mb-8 rounded-3xl border border-green-200 bg-gradient-to-r from-green-50 to-white p-6 shadow-sm dark:border-green-800 dark:from-gray-900 dark:to-gray-800">
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-green-600 text-2xl text-white">
                  ⚡
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                {parsed.actionItems.map((item, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm dark:border-emerald-800 dark:bg-gray-900"
                  >
